...
This is the whole problem of the day. Your data lives in a space with more dimensions than you can see, and the structure you care about—which signs group together, which texts resemble which—is a fact about how the points sit in that space. You need a way to look at something you can't picture.
