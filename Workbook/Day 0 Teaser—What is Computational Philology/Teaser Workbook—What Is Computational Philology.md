...
```{admonition} Companion notebook—*Hello, World*
:class: tip
Open **Teaser Notebook—Hello, World.ipynb**.
...
- Make a **Google account** (for Colab) and a **GitHub account** (for publishing), if you don't already have them.
